...
extension PlaySoundViewController: AVAudioPlayerDelegate {
    ...
    func setPlayButtonsEnabled(_ enabled: Bool) {
        slowButtun.isEnabled = enabled
        fastButtun.isEnabled = enabled
        highPitchButtun.isEnabled = enabled
        lowPitchButtun.isEnabled = enabled
        echoButtun.isEnabled = enabled
        erverbButtun.isEnabled = enabled
    }
